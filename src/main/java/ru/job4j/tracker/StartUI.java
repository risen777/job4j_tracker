...
public class StartUI {
    ...
    public static void main(String[] args) {
        ...
        UserAction[] actions = {
                new CreateAction(), new ShowAllItemsAction(), new ReplaceAction(), new DeleteAction(), new FindByIdAction(), new FindByNameAction(), new FindByNameAction(), new ExitAction()
        };
